...
class _HomePageState extends State<HomePage> {
  ...
  Widget _selectedCoinDropdown() {
    List<String> _coins = ["Bitcoin", "Ethereum", "Tether","Solana","Sui"];
    ...
    return DropdownButton(
      ...
      onChanged: (String? _newvalue ) {
        setState(() {
          _selectedCoin = _newvalue;
        });

      },
      dropdownColor: const Color.fromRGBO(83, 88, 162, 1.0),
      iconSize: 30,
  ...
  Widget _dataWidget() {
    String? lowerCaseCoin = _selectedCoin?.toLowerCase();
    return FutureBuilder(
      future: _http!.get("/coins/$lowerCaseCoin"),
        ...
        if (_snapshot.hasData) {
          ...
          return Column(
            ...
            children: [
              GestureDetector(
                onDoubleTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) {
                        return DetailsPage(rates: _exchangeRate);
              ...
              _percentageChangeWeight(_change24h),
  ...
  Widget _percentageChangeWeight(num _change) {
    return Text(
      "${_change.toString()}%",
      style: TextStyle(
        color: Colors.white,
